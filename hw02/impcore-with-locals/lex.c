...
/* lex.c 920a */
/* prototypes of private functions that help with [[getpar]] 921d */
static Name readatom(const char **ps);
/* prototypes of private functions that help with [[getpar]] 922b */
static Parlist reverse_parlist(Parlist p);
/* prototypes of private functions that help with [[getpar]] 923b */
static int  isdelim(char c);
static Name strntoname(const char *s, int n);
/* prototypes of private functions that help with [[getpar]] 923d */
...
static Par getpar_in_context(Parstream pars, bool is_first, char left) {
    if (pars->input == NULL)
        ...
        /* advance [[pars->input]] past whitespace characters 921a */
        ...
        case '(': case '[': 
            /* read and return a parenthesized [[LIST]] 921e */
            {
        ...
        default:
          ...
          /* read a [[Par]] and return that [[Par]] wrapped in [[quote]] 921b */
                {
                    pars->input++;
