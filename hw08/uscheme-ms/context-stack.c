...
/* context-stack.c 1070a */
void clearstack (Stack s) {
    s->sp = s->frames;
}
/* context-stack.c 1070c */
...
/* context-stack.c 1070d */
static Frame *pushframe (Frame f, Stack s) {
    assert(s);
    /* if stack [[s]] is full, enlarge it 1070e */
    ...
    *s->sp++ = f;
    /* set [[high_stack_mark]] from stack [[s]] 1072f */
    {   int n = s->sp - s->frames;
